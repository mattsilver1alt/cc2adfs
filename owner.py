...
class Owner:
    ...
    async def leave(self, ctx):
        ...
        if response.content.lower().strip() == "yes":
            await self.bot.say("Leaving server...")
    ...
    async def info(self):
        ...
        about = (
            "This is an instance of Red, system owned by the Fortnite Community Council and made possible by TwentySix. The profile picture and name of this bot is Copyright and intellectual property of Fortnite and Epic Games."
            "".format(red_repo, author_repo, server_url))

        embed = discord.Embed(colour=discord.Colour.red())
        embed.add_field(name="System Administrator/Owner", value=str(owner))

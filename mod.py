...
class Mod:
    ...
    async def kick(self, ctx, user: discord.Member, *, reason: str = None):
        ...
        try:
            ...
            await self.new_case(server,
                                ...
                                user=user,
                                reason=reason)
            await self.bot.say("***%s has been kicked.***\n" % (user))
    ...
    async def ban(self, ctx, user: discord.Member, days: str = None, *, reason: str = None):
        ...
        if author == user:
            ...
            await self.bot.say("Error: Forbidden (401)")
            return
        ...
        try:
            ...
            await self.new_case(server,
                                ...
                                user=user,
                                reason=reason)
            await self.bot.say("***%s has been banned.***\n" % (user))
        except discord.errors.Forbidden:
            await self.bot.say("Error: Forbidden.")
        except Exception as e:
            print(e)
    ...
    async def hackban(self, ctx, user_id: int, *, reason: str = None):
        ...
        try:
            ...
            await self.bot.say("Error, could not find user.")
    ...
    async def softban(self, ctx, user: discord.Member, *, reason: str = None):
        ...
        if can_ban:
            try:
                ...
                await self.bot.say("***%s has been softbanned.***\n" % (user))
            except discord.errors.Forbidden:
                await self.bot.say("Error: Forbidden.")
    ...
    async def rename(self, ctx, user : discord.Member, *, nickname=""):
        ...
        try:
            ...
            await self.bot.say("Done, nickname changed.")
        except discord.Forbidden:
            await self.bot.say("Error: Forbidden.")
    ...
    async def channel_mute(self, ctx, user : discord.Member, *, reason: str = None):
        ...
        try:
            ...
            await self.new_case(server,
                                ...
                                user=user,
                                reason=reason)
            await self.bot.say("***%s has been muted in this channel.***\n" % (user))
    ...
    async def server_mute(self, ctx, user : discord.Member, *, reason: str = None):
        ...
        await self.new_case(server,
                            ...
                            user=user,
                            reason=reason)
        await self.bot.say("***%s has been muted.***\n" % (user))
    ...
    async def reason(self, ctx, case, *, reason : str=""):
        ...
        try:
            ...
            await self.bot.say("You are unauthorized to edit this case.")
        except KeyError:
